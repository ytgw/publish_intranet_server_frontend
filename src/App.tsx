...
import {LT2P_PRE_SHARED_KEY, HOST} from './config'
    ...
    return (
        <div className="Manual">
            ...
            <ol>
                ...
                <li>登録後にVPN接続URL、ユーザ名、パスワード、外部アクセス用ポート番号が表示されますので、それらを保存します。<br />
                ...
                <li>VPN接続URLの外部アクセス用ポート番号にアクセスします。<br />
                    ...
                    転送設定の更新は一定周期で行っていますので、外部からアクセスできるようになるまでVPN接続から1分ほどお待ちください。<br />
                    <a href={'http://' + HOST + ':21855/'} target="_blank" rel="noreferrer">こちらのWEBページ</a> は本サービスの使用例で、イントラネット内のWEBサーバーから転送されています。
                </li>
            </ol>
        </div>
    )
